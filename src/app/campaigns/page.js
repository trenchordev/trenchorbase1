...
export default function CampaignsPage() {
  ...
  return (
    <div className="min-h-screen px-8">
      {/* Header */}
      <header className="sticky top-28 z-40 bg-[#0a0f1a]/95 backdrop-blur-md border-b border-white/5 py-4 mb-6 rounded-xl">
        <div className="flex items-center justify-between w-full">
          <div>
            <h1 className="text-4xl font-bold text-[#00ff41]">Campaigns Terminal</h1>
